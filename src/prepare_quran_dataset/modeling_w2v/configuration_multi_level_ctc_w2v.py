...
class Wav2Vec2ForMultilevelCTCConfig(PretrainedConfig):
    r"""
    ...
    Args:
        level_to_vocab_size (`dict[str, int]`, *optional*):
            ...
            Vocabulary size of the Wav2Vec2 model. Defines the number of different tokens that can be
            represented by the `inputs_ids` passed when calling [`Wav2Vec2Model`]. Vocabulary size of the
    ...
    model_type = "multi_level_ctc_w2v"
...
__all__ = ["Wav2Vec2ForMultilevelCTCConfig"]
