...
from prepare_quran_dataset.construct.utils import get_audiofile_info, download_file_fast
...
def download_sura_list(
    sura_list: list[str],
    download_dir: Path,
    base_url="https://download.quran.islamway.net/quran3/1",
):
    for sura_id in sura_list:
        print(f"Downloading sura: {sura_id}")
        sura_str = f"{sura_id:03d}"
        download_file_fast(
            f"{base_url}/{sura_str}.mp3",
            download_dir,
        )
...
if __name__ == "__main__":
    ...
    download_path = "/home/abdullah/Downloads/missing_13_0/"
    ...
    # download_sura_list(sura_list, download_path, base_url=base_url)
